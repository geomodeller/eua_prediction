...
def curate_training_test_data(df_all, Date_col_name = 'Date',
    ...
    X_train, y_train = create_sequences(train_data_scaled, sequence_length, flatten = True) # LSTM should be flatten = False
    X_test, y_test = create_sequences(test_data_scaled, sequence_length, flatten = True)
